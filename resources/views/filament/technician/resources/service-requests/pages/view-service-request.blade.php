                ...
                @php
                    $infoRows = [
                        ...
                        [
                            ...
                            'label' => 'Teknisi',
                            'value' => $record->technician?->display_username ?? 'Belum ditugaskan',
                        ],
                        [
                            ...
                            <div class="space-y-4 px-5 py-4">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-sm font-semibold text-gray-900 dark:text-white">{{ $repair->technician?->display_username ?? 'Belum dijadwalkan' }}</p>
                                    </div>
                                </div>
                                <div class="flex items-center gap-3">
                                    <div class="flex h-9 w-9 shrink-0 items-center justify-center rounded-xl bg-orange-50 dark:bg-orange-900/20">
