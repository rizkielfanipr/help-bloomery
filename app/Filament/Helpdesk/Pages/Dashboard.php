...
class Dashboard extends BaseDashboard
{
    ...
    private function computeModuleStats(): void
    {
        ...
        $statusUrl = fn (string $routeName, array $statuses): string => route($routeName, [
            'filters' => ['status' => ['values' => $statuses]],
        ]);
        ...
        $this->moduleStats = [
            [
                ...
                'pending_href' => $statusUrl('filament.helpdesk.resources.service-requests.index', $pendingService),
                'completed_href' => $statusUrl('filament.helpdesk.resources.service-requests.index', [ServiceRequestStatus::Completed->value]),
            ...
            [
                ...
                'pending_href' => $statusUrl('filament.helpdesk.resources.erp-repair-requests.index', $pendingRequest),
                'completed_href' => $statusUrl('filament.helpdesk.resources.erp-repair-requests.index', [RequestStatus::Completed->value]),
            ...
            [
                ...
                'pending_href' => $statusUrl('filament.helpdesk.resources.design-requests.index', $pendingDesign),
                'completed_href' => $statusUrl('filament.helpdesk.resources.design-requests.index', [DesignRequestStatus::Completed->value]),
            ...
            [
                ...
                'pending_href' => $statusUrl('filament.helpdesk.resources.purchase-requests.index', $pendingPurchase),
                'completed_href' => $statusUrl('filament.helpdesk.resources.purchase-requests.index', [PurchaseRequestStatus::Completed->value]),
            ...
            [
                ...
                'pending_href' => route('filament.helpdesk.resources.casual-clock-records.index', [
                    'filters' => ['work_date' => ['date' => today()->toDateString()]],
                ]),
                'completed_href' => route('filament.helpdesk.resources.casual-overtime-requests.index'),
            ...
            [
                ...
                'pending_href' => route('filament.helpdesk.resources.briefing-items.index', [
                    'filters' => ['review_status' => ['values' => [
                        BriefingReviewStatus::LegacyPending->value,
                        BriefingReviewStatus::SupervisorReview->value,
                    ]]],
                ]),
                'completed_href' => route('filament.helpdesk.resources.briefing-items.index', [
                    'filters' => ['review_status' => ['values' => [BriefingReviewStatus::Approved->value]]],
                ]),
            ...
            [
                ...
                'pending_href' => $statusUrl('filament.helpdesk.resources.trips.index', [TripStatus::InProgress->value]),
                'completed_href' => $statusUrl('filament.helpdesk.resources.trips.index', [TripStatus::Completed->value]),
            ...
            [
                ...
                'pending_href' => route('filament.helpdesk.resources.sales-reports.index', [
                    'filters' => ['report_date' => [
                        'from' => now()->startOfMonth()->toDateString(),
                        'until' => now()->endOfMonth()->toDateString(),
                    ]],
                ]),
                'completed_href' => route('filament.helpdesk.resources.sales-reports.index', [
                    'filters' => ['report_date' => [
