...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .icon-wrap { width: 72px; height: 72px; background: #f8fafc; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 1.25rem; }
        .icon-wrap svg { width: 32px; height: 32px; color: #94a3b8; }
...
<body>
    <div class="card">
        ...
        <p class="desc">Halaman yang kamu cari tidak ada atau sudah dipindahkan.</p>
