...
class LauncherPage extends Page
{
    ...
    public function mount(): void
    {
        ...
        if ($user?->hasRole('DRIVER')) {
            $this->redirect(TripDashboard::getUrl());
        }
    }
    ...
    public function tiles(): array
    {
        ...
        $all = [
            ...
            [
                ...
                'permission' => 'view tile req teknisi',
            ],
            [
                'label' => 'Briefing',
                'iconBg' => 'bg-violet-50',
            ...
            [
                ...
                'permission' => 'view tile purchasing',
            ],
            [
                'label' => 'Desain',
                'iconBg' => 'bg-pink-50',
                ...
                'href' => route('filament.casual.pages.design-request-page'),
                'permission' => 'view tile desain',
            ],
            [
                'label' => 'ERP',
                'iconBg' => 'bg-indigo-50',
                ...
                'path' => 'M20.25 6.375c0 2.278-3.694 4.125-8.25 4.125S3.75 8.653 3.75 6.375m16.5 0c0-2.278-3.694-4.125-8.25-4.125S3.75 4.097 3.75 6.375m16.5 0v11.25c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125V6.375m16.5 2.625c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125m16.5 5.625c0 2.278-3.694 4.125-8.25 4.125s-8.25-1.847-8.25-4.125',
                'href' => ErpRequestPage::getUrl(),
                'permission' => 'view tile erp',
            ],
        ];

        return array_values(array_filter($all, fn ($tile) => $user->can($tile['permission'])));
    }
