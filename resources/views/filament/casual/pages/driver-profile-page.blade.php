...
<div class="flex flex-col bg-blue-600 dark:bg-blue-900"
    ...
    {{-- ════════════════════════════════════════════
         EMERALD HEADER — avatar + name + tags
    ════════════════════════════════════════════ --}}
    <div class="flex-shrink-0 px-5 pb-12 pt-14 text-center">
        ...
        <div class="mt-2 flex items-center justify-center gap-2">
            <span class="rounded-full bg-white/20 px-3 py-1 text-xs font-semibold text-white">Driver</span>
        </div>
        ...
        <div class="mx-5 mt-4 overflow-hidden rounded-2xl bg-white ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
            ...
            <a href="{{ \App\Filament\Casual\Pages\TripHistory::getUrl() }}"
               class="flex w-full items-center gap-3 px-5 py-4 transition active:bg-gray-50 dark:active:bg-gray-800">
                ...
                <span class="flex-1 font-semibold text-gray-900 dark:text-white">Riwayat Perjalanan</span>
            ...
            <a href="{{ \App\Filament\Casual\Pages\StartTrip::getUrl() }}"
               class="flex w-full items-center gap-3 px-5 py-4 transition active:bg-gray-50 dark:active:bg-gray-800">
                ...
                <span class="flex-1 font-semibold text-gray-900 dark:text-white">Mulai Perjalanan</span>
                <svg class="h-4 w-4 text-gray-300 dark:text-gray-600" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" d="m8.25 4.5 7.5 7.5-7.5 7.5"/>
                </svg>
            </a>
    ...
    <x-driver.bottom-nav active="profile" />
