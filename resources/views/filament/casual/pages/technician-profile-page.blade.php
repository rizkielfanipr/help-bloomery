...
<div class="flex flex-col bg-orange-500 dark:bg-orange-900"
    ...
    <div class="flex-shrink-0 px-5 pb-12 pt-14 text-center">
        ...
        <div class="relative mx-auto w-fit">
                    ...
                    <div class="h-full w-full">
                        @if($user->avatar)
                            <img src="{{ \Illuminate\Support\Facades\Storage::url($user->avatar) }}"
                                 ...
                                 alt="{{ $user->name }}">
                        @else
                            <div class="flex h-full w-full items-center justify-center bg-orange-400 text-2xl font-semibold text-white">
                                {{ $initials }}
                            </div>
                        @endif
                    </div>
            ...
            <button @click="openPicker()"
                    ...
                    class="absolute -bottom-1 -right-1 flex h-9 w-9 items-center justify-center rounded-full bg-white text-orange-500 ring-2 ring-orange-100 transition active:scale-90">
        ...
        <div class="mt-3 flex items-center justify-center gap-1.5 text-orange-200">
        ...
        <div x-show="hasPhoto && !uploading" x-transition class="mt-5 flex gap-3">
            ...
            <button wire:click="savePhoto"
                    class="flex flex-1 items-center justify-center gap-1.5 rounded-2xl bg-white py-3 text-sm font-semibold text-orange-600 transition active:scale-95">
    ...
    <div class="flex-1 rounded-t-3xl bg-gray-50 pb-28 dark:bg-gray-950">
        ...
        <div class="mx-5 mt-5 overflow-hidden rounded-2xl bg-white ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
            ...
            <div class="flex items-center justify-between px-5 py-4">
                ...
                <span class="text-sm font-semibold text-gray-900 dark:text-white">{{ $user->employee_id ?? '—' }}</span>
            </div>
        ...
        <div class="mx-5 mt-4 overflow-hidden rounded-2xl bg-white ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
            ...
            <a href="{{ \App\Filament\Casual\Resources\ServiceRequests\ServiceRequestResource::getUrl('index') }}"
               class="flex w-full items-center gap-3 px-5 py-4 transition active:bg-gray-50 dark:active:bg-gray-800">
                <div class="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-xl bg-orange-100 dark:bg-orange-900/30">
                    <svg class="h-5 w-5 text-orange-500 dark:text-orange-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
    ...
    <div x-show="mode === 'picker'"
        ...
        <div class="flex flex-col items-center gap-3 px-5 pb-5 pt-3">
            <div class="relative">
                <div class="h-16 w-16 overflow-hidden rounded-full ring-4 ring-orange-100 dark:ring-orange-900/40">
                    @if($user->avatar)
                        <img src="{{ \Illuminate\Support\Facades\Storage::url($user->avatar) }}"
                             class="h-full w-full object-cover" alt="{{ $user->name }}">
                    @else
                        <div class="flex h-full w-full items-center justify-center bg-orange-400 text-xl font-semibold text-white">
                            {{ $initials }}
                        </div>
                    @endif
                </div>
                <div class="absolute -bottom-1 -right-1 flex h-6 w-6 items-center justify-center rounded-full bg-orange-500 ring-2 ring-white dark:ring-gray-900">
        ...
        <div class="flex flex-col gap-3 px-5 pb-4">
            <button @click="chooseCamera()"
                    class="flex w-full items-center gap-4 rounded-2xl bg-orange-50 px-4 py-3.5 text-left transition active:bg-orange-100 dark:bg-orange-900/20">
                <div class="flex h-12 w-12 flex-shrink-0 items-center justify-center rounded-xl bg-orange-500">
    ...
    <div x-show="mode === 'camera'"
        ...
        <div class="flex items-center justify-between px-5 pb-4 pt-3">
            <div>
                <div class="text-xs font-semibold uppercase tracking-widest text-orange-400">Foto Profil</div>
        ...
        <div class="px-6 pb-12 pt-5">
            ...
            <div x-show="hasPhoto && !uploading" class="flex gap-3">
                ...
                <button @click="usePhoto()"
                        class="flex flex-1 items-center justify-center gap-2 rounded-2xl bg-orange-500 py-4 text-sm font-semibold text-white transition active:scale-95">
                    <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="m4.5 12.75 6 6 9-13.5"/>
                    </svg>
                    Gunakan Foto
