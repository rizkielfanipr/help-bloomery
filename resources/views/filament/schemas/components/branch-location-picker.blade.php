...
>
    ...
    <div class="relative">
        <input
            ...
            class="w-full rounded-lg border border-gray-300 bg-white px-3 py-2 pr-10 text-sm text-gray-900 focus:border-blue-500 focus:outline-none focus:ring-1 focus:ring-blue-500 dark:border-white/10 dark:bg-white/5 dark:text-white dark:placeholder-gray-400"
        >
        <button
            type="button"
            @click="search()"
    ...
    {{-- Map with a floating "my location" button --}}
    <div wire:ignore class="relative">
        ...
        <button
            ...
            class="absolute bottom-8 right-3 z-[1000] flex h-10 w-10 items-center justify-center rounded-full border border-gray-300 bg-white text-gray-700 transition hover:border-blue-400 hover:bg-blue-50 hover:text-blue-700 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 disabled:cursor-not-allowed disabled:opacity-60 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-200"
        >
    ...
    <p class="text-xs text-gray-400">Klik peta, seret pin, gunakan tombol lokasi saya di pojok peta, atau cari nama lokasi untuk menentukan titik absen</p>
