    ...
    $allNavGroups = [
        ...
        [
            ...
            'items' => [
                ...
                ['label' => 'Bobot Penilaian',    'icon' => 'scale',           'perm' => 'edit briefing period weights', 'href' => $r('filament.helpdesk.pages.briefing-period-weights-page'), 'active' => $active($r('filament.helpdesk.pages.briefing-period-weights-page'))],
        ...
        [
            ...
            'icon'  => 'shopping-cart',
            'items' => [
                ['label' => 'Vendor Compliance', 'icon' => 'shield-check', 'perm' => 'view vendor compliance incidents', 'href' => $r('filament.helpdesk.resources.vendor-compliance-incidents.index'), 'active' => $active($r('filament.helpdesk.resources.vendor-compliance-incidents.index'))],
...
<div class="flex h-full w-full flex-col border-r border-slate-200/80 bg-white dark:border-white/[0.06] dark:bg-[#0F172A]"
    ...
    <nav class="flex-1 overflow-y-auto px-3 py-3 space-y-0.5" style="scrollbar-width:thin">
        ...
        <a
            x-show="!hasSearch()"
            href="{{ \App\Filament\Casual\Pages\LauncherPage::getUrl() }}"
            target="_blank"
