...
@once
    <span
        class="hidden"
        x-init="
            if (window.serviceRequestSelectionSyncInstalled) return
            window.serviceRequestSelectionSyncInstalled = true
    ...
    @switch($name)
        ...
        @case('scheduled_date')
            <div
                x-data="{
                    open: false,
                    from: $wire.entangle('tableFilters.scheduled_date.from').live,
                    until: $wire.entangle('tableFilters.scheduled_date.until').live,
                    draftFrom: null,
                    draftUntil: null,
                    hover: null,
                    cursor: new Date(),
