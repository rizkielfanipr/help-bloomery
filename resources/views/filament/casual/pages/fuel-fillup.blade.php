...
<div class="flex flex-col bg-blue-600 dark:bg-blue-900" style="min-height:100dvh">
    ...
    <div class="flex-shrink-0 px-5 pb-8 pt-14">
        <div class="mb-4 flex items-center gap-3">
            <a href="{{ \App\Filament\Casual\Pages\ActiveTrip::getUrl(['trip' => $this->trip]) }}"
        ...
        <p class="text-blue-200">{{ $this->tripModel->tripRoute?->name ?? '' }}</p>
            ...
            <div class="flex flex-col gap-5 rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-700 dark:bg-gray-900">
                ...
                <div>
                    ...
                    <button type="button" @click="openPhoto('nota')"
                            class="flex w-full cursor-pointer items-center justify-center gap-2 rounded-xl border border-dashed border-gray-300 py-4 transition hover:border-blue-300 hover:bg-blue-50 dark:border-gray-700 dark:hover:border-blue-600 dark:hover:bg-blue-900/20">
...
<div x-show="mode === 'picker'"
    ...
    <div class="flex flex-col gap-3 px-5 pb-4">
        <button @click="chooseCamera()"
            ...
            <svg class="h-4 w-4 shrink-0 text-blue-300" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
