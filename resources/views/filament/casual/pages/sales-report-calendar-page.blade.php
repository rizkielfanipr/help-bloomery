...
<div class="flex flex-col bg-blue-600 dark:bg-blue-900" style="min-height:100dvh">
    ...
    <div class="flex-shrink-0 px-5 pb-6 pt-14">
        <div class="mb-4 flex items-center gap-3">
            ...
            <span class="text-base font-semibold text-white">Kalender Sales Report</span>
        </div>
        ...
        <div class="px-4">
            ...
            <div class="grid grid-cols-7 gap-1">
                ...
                @foreach($calendar['days'] as $day)
                    ...
                    <div class="flex aspect-square flex-col items-center justify-center rounded-xl ring-1 ring-black/5 {{ $cellBg }}">
            ...
            <div class="mt-5 space-y-2">
                ...
                <div class="flex flex-col gap-1.5">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-xs text-gray-500">Belum ada sales report</span>
                    </div>
                </div>
            </div>
    ...
    <x-sales-report.bottom-nav active="calendar" />
</div>
