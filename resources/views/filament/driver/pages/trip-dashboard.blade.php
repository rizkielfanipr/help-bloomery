            ...
            <div class="mx-5">
                ...
                <div class="overflow-hidden rounded-2xl bg-white ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
                    <div class="flex items-center gap-3 px-5 pt-5">
                        ...
                        <span class="flex items-center gap-1.5 rounded-full bg-emerald-100 px-2.5 py-1 text-xs font-semibold text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-400">
                    ...
                    <div class="px-5 py-4">
                        <a href="{{ \App\Filament\Driver\Pages\ActiveTrip::getUrl(['trip' => $trip->id]) }}"
                           class="flex w-full items-center justify-center gap-2 rounded-xl bg-emerald-600 py-3 text-sm font-semibold text-white transition active:scale-95 active:bg-emerald-700">
            ...
            <div class="mx-5">
                <div class="overflow-hidden rounded-2xl bg-white ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
                    <div class="flex flex-col items-center gap-4 px-5 py-10 text-center">
                        <div class="flex h-16 w-16 items-center justify-center rounded-2xl bg-emerald-50 dark:bg-emerald-900/20">
                        ...
                        <a href="{{ \App\Filament\Driver\Pages\StartTrip::getUrl() }}"
                           class="flex items-center gap-2 rounded-xl bg-emerald-600 px-6 py-2.5 text-sm font-semibold text-white transition active:scale-95 active:bg-emerald-700">
                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.5">
            ...
            <div class="mx-5 mt-5">
                <div class="mb-3 flex items-center justify-between">
                    ...
                    <a href="{{ \App\Filament\Driver\Pages\TripHistory::getUrl() }}"
                       class="text-xs font-medium text-emerald-600 dark:text-emerald-400">Lihat Semua</a>
                </div>
                <div class="overflow-hidden rounded-2xl bg-white ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
