...
final class HelpdeskNavigation
{
    ...
    public static function technicianItems(Closure $route, Closure $active): array
    {
        return [
            ...
            ['label' => 'Asset QR', 'icon' => 'qr-code', 'perm' => 'view assets', 'href' => $route('filament.helpdesk.resources.assets.index'), 'active' => $active($route('filament.helpdesk.resources.assets.index'))],
