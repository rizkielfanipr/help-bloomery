    ...
    public function run(): void
    {
        ...
        Role::firstOrCreate(['name' => 'HRD_STAFF', 'guard_name' => 'web'])
            ->syncPermissions([
                ...
                'access employee app purchasing', 'access employee app design', 'access employee app content', 'access employee app erp',
                ...
                'view content requests', 'edit content requests',
                'view users',
