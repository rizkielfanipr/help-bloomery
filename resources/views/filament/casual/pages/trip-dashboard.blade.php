                ...
                <div class="overflow-hidden rounded-2xl bg-white ring-1 ring-black/5 dark:bg-gray-900 dark:ring-white/10">
                    @foreach($this->recentTrips as $index => $trip)
                        <a href="{{ \App\Filament\Casual\Pages\TripDetail::getUrl(['trip' => $trip->id]) }}"
                           ...
                           class="flex items-center gap-3 px-5 py-3.5 transition hover:bg-blue-50/60 active:bg-blue-50 dark:hover:bg-blue-900/10 {{ $index > 0 ? 'border-t border-gray-100 dark:border-gray-800' : '' }}">
