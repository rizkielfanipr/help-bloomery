...
class ViewServiceRequest extends ViewRecord
{
    ...
    protected string $view = 'filament.casual.resources.service-requests.pages.view-service-request';
    ...
    public function infolist(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Detail Permintaan')->schema([
                ...
                TextEntry::make('warranty_claim_notes')
                    ->label('Pengaduan Garansi')
                    ->placeholder('-')
                    ->visible(fn (): bool => $this->record->warranty_claim_notes !== null),
            ]),

            Section::make('Foto Pengaduan Garansi')
                ->schema([
                    ImageEntry::make('warranty_claim_attachments')
                        ->label('Foto Kendala')
                        ->disk('b2')
                        ->size(200)
                        ->default(null),
                ])
                ->visible(fn (): bool => ! empty($this->record->warranty_claim_attachments)),
            ...
            Action::make('mulai_kerjakan')
                ...
                ->action(function (ServiceRequest $record, array $data): void {
                    ...
                    ServiceRequestRepair::create([
                        ...
                        'warranty_claim_attachments' => $record->warranty_claim_attachments,
                    ]);
            ...
            Action::make('selesai_kerjakan')
                ...
                ->action(function (ServiceRequest $record, array $data): void {
                    ...
                    $record->update([
                        ...
                        'warranty_claim_attachments' => null,
                    ]);
