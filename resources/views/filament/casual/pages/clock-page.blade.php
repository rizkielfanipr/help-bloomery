...
<div class="flex flex-col bg-blue-600 dark:bg-blue-900"
     ...
     x-data="{
         ...
         async shoot() {
             ...
             // Face detection — skip in mockMode (no real camera)
             if (!this.mockMode && this.faceModelReady) {
                 ...
                 try {
                     ...
                     this.detectingFace = false;
                     // Detection error — allow photo through rather than blocking
                 }
             }
    ...
    <div class="flex-shrink-0 px-5 pb-8 pt-14">
        ...
        <div class="flex items-center justify-between">
            ...
            <button
                ...
                "
                :title="document.documentElement.classList.contains('dark') ? 'Mode Terang' : 'Mode Gelap'"
            >
    ...
    <div x-show="action !== null"
        ...
        <div class="absolute inset-x-0 top-0 z-10 px-5 pb-5 pt-12"
            ...
            {{-- Zone banner: hidden until location check is properly implemented --}}
        </div>
        ...
        {{-- Photo ready badge: hidden for now --}}
